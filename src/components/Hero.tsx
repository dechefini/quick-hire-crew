    ...
    <section className="hero-section py-16 md:py-24 lg:py-32">
      <div className="container mx-auto px-4 text-center">
        <h1 className="text-3xl md:text-4xl lg:text-6xl font-bold text-primary mb-6 md:mb-8">
          Build Your Future in {isMobile ? "" : <br />} Construction
        </h1>
        ...
        <div className="mb-6 md:mb-10">
          <div className="inline-flex flex-wrap justify-center items-center gap-2 bg-white rounded-md p-2 shadow-sm mb-8">
            ...
            <Button variant="default" className="bg-primary text-white rounded-md px-3 md:px-4 py-1 h-auto">
              English
            </Button>
            <Button variant="ghost" className="text-gray-700 rounded-md px-3 md:px-4 py-1 h-auto">
              Español
            </Button>
          </div>
        </div>
